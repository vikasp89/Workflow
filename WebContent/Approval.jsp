...
<button type="button" class="btn btn-primary" id="cadbsbtn"
					...
					<form style="margin-top: 0px" class="form-inline" action=""
						...
						<%
						while (rs.next()) {
							System.out.println("rs.next( hit");
 ...
 %> <input class="form-check-input starterkit" onclick="return false;"
																					...
																					value="2" style="width: 28px; height: 28px;  margin-left:10px"">
																					<%
																					}
																					%>
															...
															<div class="row">
																...
																<div class="col-lg-3 col-md-3 col-sm-3">
																	<input type="text" disabled
																		...
																		id="Planned_No" placeholder="Planned No"
																		value="<%=planned_no%>">
																</div>
																...
																<div class="col-lg-3 col-md-3 col-sm-3">
																	...
																	<input type="text" disabled
																		...
																		name="planningType" id="planningType"
																		value="<%=planning_type%>">
													...
													<table role="grid"
														...
														String issueName="";
															...
															while (rpt_rs.next()) {
																...
																System.out.println("jsp issue: "+issue);
																if (patientName == null)
																	patientName = "";
																...
																if (lower_aligner == null)
																	...
																	for (Newcase1 issueList : rptIssue) {
																		if (issue.equals(issueList.getIssueid())) {
																			...
																			System.out.println(issueList.getIssueid()+ " jsp issueName: "+issueName);
