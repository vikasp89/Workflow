...
<div class="container" style="padding-top:20px;">
  <div class="panel panel-primary">
    <div class="panel-heading"><strong>UnHold Case</strong> </div>
...
<span style="color:red" class="required">*</span></label>
       ...
       <tr>
 	   ...
 	   <td  width="50%">
			<a class="btn btn-primary" style="display:none;" id="submitButton" style="margin-left:-66px;" name="BtnSubmit1" onclick="genrateDocs()">GenerateBarcode</a>
			  ...
			  <td width="50%">
         <button class="btn btn-primary" type="button" id="searchScreen" name="searchScreen"  value='searchScreen'>UnHold</button></td>   
	...
	if(case_number!=''){
		 $.ajax({
		 	    ...
		 	    type : 'POST',
		 		data : {case_number:case_number,username:username,remarks:remarks},
