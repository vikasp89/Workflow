...
<body class="nav-md">
	...
	<form name="MyInvoiceForm" id="MyInvoiceForm" method="post"
		action="${pageContext.request.contextPath}/Findnextdispatchdate"
		target="_self">
						...
						<div class="container" style="padding-top: 20px;">
							<div class="panel panel-primary">
								<div class="panel-heading">
									<strong>Find Next Dispatch Date</strong>
								</div>
								<div class="table-responsive"
									...
									<div style="padding: 10px 0px 0px 0px;">
										<div class="form-group" id="D">
											<label>Search By Case Number</label> <span style="color: red"
												class="required">*</span></label> <span
												style="padding-left: 129px; margin-top: 5px;"> <input
												class="form-control" id="case_number" name="case_number">
									...
									<div style="padding: 10px 0px 0px 0px;">
										<div class="form-group" id="D">
											<label>Search By Date <span style="color: red"
												class="required">*</span></label> <span
												style="padding-left: 152px;; margin-top: 5px;"> </span>
									...
									<div class="table-responsive">
										<table class="table table-no-bordered">
											<tr>
												...
												<td width="50%">From Date : <input class="form-control"
													type="date" name="fromdate" /></td>
												<td width="50%">To Date : <input class="form-control"
											...
											<tr>
												...
												<td width="50%" align="right">
													<button class="btn btn-success" type="submit"
														id="searchScreen" name="searchScreen" value='searchScreen'>Search</button>
												</td>
